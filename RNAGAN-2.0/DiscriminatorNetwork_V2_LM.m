function netD = DiscriminatorNetwork_V2_LM(pathwayMatrix,numRef)
...
tempNet = [
    ...
    selfAttentionLayer(4,featureSize,"Name","selfattention");
    layerNormalizationLayer("Name","norm_3");
...
netD = connectLayers(netD,"swish_2","addition_1/in2");
netD = connectLayers(netD,"addition_1","addition_2/in2");
