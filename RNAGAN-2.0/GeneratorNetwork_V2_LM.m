function netG = GeneratorNetwork_V2_LM(pathwayMatrix,numRef)
...
netG = connectLayers(netG,"swish_2","addition_1/in2");
netG = connectLayers(netG,"addition_1","addition_2/in2");
